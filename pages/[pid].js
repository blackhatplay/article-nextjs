...
export async function getStaticPaths() {
    ...
    try {
        const res = await server.get(`${process.env.NEXT_PUBLIC_SERVER}/api/post/all/paths`);
...
export async function getStaticProps({ params }) {
    try {
        const res = await server.get(`${process.env.NEXT_PUBLIC_SERVER}/api/post/${params.pid}`);
