import { Box, Button, Card, CardContent, Divider, Grid, IconButton, makeStyles, Typography } from '@material-ui/core';
            ...
            <Card className={classes.root} variant='outlined'>
                <CardContent>
                    ...
                    <Box className={classes.topicWrapper}>
                        <Grid container justifyContent='space-between' className={classes.topicItem}>
                            <Grid item>
