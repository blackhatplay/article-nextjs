import { Button, Container, Grid, IconButton, makeStyles, Menu, MenuItem, Toolbar, Typography } from '@material-ui/core';
...
const Header = ({ isLoggedIn, user, handleDrawerToggle, drawer }) => {
    ...
    return (
        <>
            <AppBar position='fixed' className={drawer ? classes.appBarDrawer : classes.appBar}>
                {drawer ? (
                    toolbar
                ) : (
