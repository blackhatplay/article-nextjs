...
const Layout = (props) => {
    ...
    const drawer = (
        <Box className={classes.wrapper}>
            ...
            <Box>
                <Divider />
                <List className={classes.listWrapper}>
                    <ListItem button onClick={() => router.push(`/dashboard/setting`)} justifyContent='center'>
                        <ListItemAvatar>
                    ...
                    <ListItem button onClick={onLogoutClick} justifyContent='center'>
                        <ListItemAvatar>
                            <Avatar className={classes.avatar}>
    ...
    return (
        <div className={classes.root}>
            <Header handleDrawerToggle={handleDrawerToggle} drawer isLoggedIn={isLoggedIn} user={user} />
